...
<CardGrid>
  <Card title="ConsoleLogs" icon="terminal">
...
Version compatibility information will be added here to help you choose the right module versions for your DiSky installation.
</Aside>

### Planned Compatibility Matrix

This section will include:
- Module versions compatible with each DiSky version
- Minimum Skript version requirements
- JDA version dependencies
...
- Confirm active Patreon subscription
- Download from [DiSky Resources](https://resources.disky.me/resources?premium)
- Join [DiSky Discord](https://disky.me/discord) for support

## Next Steps

<CardGrid>
  <Card title="Install ConsoleLogs" icon="rocket">
    Try the free ConsoleLogs module to get started with modules

    [ConsoleLogs Guide →](/modules/consolelogs)
  </Card>

  <Card title="Explore Premium" icon="star">
    See what premium modules can do for your bot

    [View All Modules →](#available-modules)
  </Card>

  <Card title="Get Support" icon="discord">
    Join our Discord community for help and updates

    [Join Discord →](https://disky.me/discord)
  </Card>
</CardGrid>
