...
<Aside>
Now that you understand the deprecation of this module, take these next steps:
</Aside>

- **[Read the New Documentation](/messages/webhooks)** - Learn the modern webhook syntax
- **[DiSky Messages Guide](/messages/introduction)** - Explore message creation features
- **[DiSky Components](/messages/components)** - Add buttons and menus to webhook messages
- **[Other Modules](/modules/lavaplayer)** - Discover active DiSky modules
