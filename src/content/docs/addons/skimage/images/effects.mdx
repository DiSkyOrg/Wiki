...
<Tabs>
  ...
  <TabItem label="Increased Brightness (+40%)">
    ![Increased Brightness](images/6_Brightness (+40%).png)
  </TabItem>
  <TabItem label="Decreased Brightness (-40%)">
    ![Decreased Brightness](images/7_Brightness (-40%).png)
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="With Contrast Effect">
    ![Contrast Effect](images/8_Contrast.png)
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="With Grayscale Effect">
    ![Grayscale Effect](images/1_Grayscale.png)
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="With Sepia Effect">
    ![Sepia Effect](images/2_Sepia.png)
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Red Tint">
    ![Red Tint](images/3_Red Tint.png)
  </TabItem>
  <TabItem label="Blue Tint">
    ![Blue Tint](images/4_Blue Tint.png)
  </TabItem>
  <TabItem label="Green Tint">
    ![Green Tint](images/5_Green Tint.png)
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="With Invert Effect">
    ![Invert Effect](images/10_Invert.png)
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="With Pixelate Effect">
    ![Pixelate Effect](images/11_Pixelate.png)
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="With Grayscale + Blur Effect">
    ![Composite Effect](images/12_Grayscale + Blur.png)
  </TabItem>
</Tabs>
...
<Aside>
  Now that you know how to apply effects, explore more features:

  - [Image Management](./images) - Learn more about image manipulation
  - [Graphics Management](../graphics/graphics) - Draw shapes and text on images
  - [GIFs](../gifs) - Create animated GIFs with effects
</Aside>
