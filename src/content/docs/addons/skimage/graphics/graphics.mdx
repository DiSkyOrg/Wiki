...
<Tabs>
  <TabItem label="Rectangle">
    ...
    ![rectangle.png](/images/skimage/shape-1.png)
  </TabItem>
  <TabItem label="Rounded rectangle">
    ...
    ![rounded-rectangle.png](/images/skimage/shape-2.png)
  </TabItem>
  <TabItem label="Arc">
    ```applescript
    ...
    ![arc.png](/images/skimage/shape-3.png)
  </TabItem>
  <TabItem label="Line">
    ```applescript
    ...
    ![line.png](/images/skimage/shape-4.png)
  </TabItem>
  <TabItem label="Polygon">
    ...
    ![polygon.png](/images/skimage/shape-5.png)
  </TabItem>
</Tabs>
